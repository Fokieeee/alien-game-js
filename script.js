window.addEventListener("load", function () {
  ...
  class Particle {
    constructor(game, x, y) {
      ...
      this.spriteSize = 50;
      this.sizeModifier = (Math.random() * 1 + 0.5).toFixed(1);
  ...
  class Player {
    ...
    update(deltaTime) {
      ...
      } else if (this.y > this.game.height - this.height / 2) {
  ...
  class Game {
    ...
    update(deltaTime) {
      ...
      //ammo update
      if (this.player.powerUp) this.ammoModifier = 2;
      else this.ammoModifier = 1;
      if (this.ammoTimer > this.ammoInterval) {
        if (this.ammo < this.maxAmmo) this.ammo += this.ammoModifier;
        this.ammoTimer = 0;
      } else {
    ...
    addExplosion(enemy) {
      ...
      if (randomize < 0.5)
        ...
        this.explosions.push(
          new FireExplosion(this, enemy.x + enemy.width / 2, enemy.y)
        );
    }
